...
if uploaded_file:
    ...
    if selected_sheet:
        ...
        ax.text(1.05, 1.75, select_player1, fontsize=18, color=color_1, ha='left', va='center')
        ax.text(1.95, 1.75, select_player2, fontsize=18, color=color_2, ha='right', va='center')
